...
<body>
    <div class="container">
        ...
        <div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @endphp
                                <a class="btn btn-danger" href="{{ $url  }} ">Giam</a>
                                {{ $item['quantity'] }}
                                ...
                                @endphp
                                <a class="btn btn-danger" href="{{ $url  }} ">Tang</a>
                            ...
                            <td>
                                ...
                                @endphp
                                <a onclick="return confirm ('Co chac chan khong?')" href="{{ url('cart/remove')  }}?productID={{ $item['id'] }}">Xoa</a>
                            </td>
                        </tr>
                        @endforeach
            ...
            <div class="col-mb-4 mb-2 mt-2">

                <form action="{{ url('order/checkout') }} " method="POST">
                    <div class="mb-3 mt-3">
                        <label for="name" class="form-label">Name:</label>
                        <input type="name" class="form-control" id="name" value="{{ $_SESSION['user']['name'] ?? null }}" placeholder="Enter email" name="user_name">
                    </div>
                    <div class="mb-3 mt-3">
